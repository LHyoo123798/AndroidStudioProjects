...
```
#### NotesList.java中onOptionsItemSelected方法添加
```
...
![image](/TestImage/notepad_sort4.png)
...
```
#### NoteEditor.java中onOptionsItemSelected方法添加
```
...
```
#### 在NoteEditor.java中添加方法changeColor
```
